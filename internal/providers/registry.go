...
func Registry() []Provider {
	return withDerivedMetadata([]Provider{
		...
		{ID: "unpaywall", Name: "Unpaywall", Category: "open access", Capabilities: []string{"enrich.doi"}, AuthType: AuthNone, SetupURL: "https://unpaywall.org/products/api", FreeTier: "Free public API; email required", LimitModel: "verify quota before high-volume", LimitConfidence: "documented", Status: CapabilitySupported},
